...
/**  
 * Title: DataTableParameter
 * Description: 
 * @author linkan  
 * @date 2019年1月30日  
 */
public class DataTableParameter {
	public DataTableParameter(int sEcho, int iDisplayStart, int iDisplayLength, int iColumns, 
			List<String> mDataProps, List<Boolean> bSortables, int iSortingCols, 
			List<Integer> iSortCols, List<String> sSortDirs,List<String> iSortColsName) {
		this.sEcho = sEcho;
